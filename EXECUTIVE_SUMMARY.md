# Executive Summary - Cypress to Tosca Migration
...
**Attachments:**
- Migration Summary Report (`output/validation-report.json`)
- Sample Migration Artifacts (`tosca-output/xml/Modules.xml`, `tosca-output/xml/TestCases.xml`)
- Excel Import Files (`tosca-output/excel/Modules.xlsx`, `tosca-output/excel/TestCases.xlsx`)
- Technical Architecture Overview (`AGENTS.md`)
- Canonical IR (`output/migration.json`)
